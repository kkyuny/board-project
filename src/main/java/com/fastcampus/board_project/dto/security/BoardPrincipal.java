...
public record BoardPrincipal(
        String username,
        String password,
        Collection<? extends GrantedAuthority> authorities, // 콜렉션인 이유는 권한이 여러개일 수 있기 때문
        String email,
        String nickname,
        String memo,
        Map<String, Object> oAuth2Attributes
) implements UserDetails, OAuth2User { // UserDetails: 폼 로그인 기반 로그인, OAuth2User: 외부 OAuth 기반 로그인
