...
-- 대댓글
insert into article_comment (article_id, user_id, parent_comment_id, content, created_at, modified_at, created_by, modified_by) values
(10, 'uno', 1, '퍼가요~', '2021-03-02 22:40:04', '2021-04-27 15:38:09', 'Uno', 'Uno'),
(10, 'uno2', 1, '퍼가요~', '2021-03-03 22:40:04', '2021-04-27 15:38:09', 'Uno2', 'Uno2'),
(10, 'uno', 1, '또 퍼가요~', '2021-03-04 22:40:04', '2021-04-27 15:38:09', 'Uno', 'Uno'),
(10, 'uno', 1, '또또 퍼가요~', '2021-03-05 22:40:04', '2021-04-27 15:38:09', 'Uno', 'Uno')
;

insert into hashtag (hashtag_name, created_at, modified_at, created_by, modified_by) values
('blue', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('crimson', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('fuscia', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('goldenrod', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('green', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('indigo', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('khaki', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('maroon', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('mauv', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('orange', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('pink', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('puce', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('purple', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('red', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('teal', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('turquoise', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('violet', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('yellow', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno'),
('white', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'uno', 'uno');
